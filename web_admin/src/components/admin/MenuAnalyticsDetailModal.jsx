      ...
      <div className="glass-card" style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '14px' }}>
          ...
          <div style={{ background: T.warningBg, border: `1px solid ${T.warningBorder}`, borderRadius: '16px', padding: '16px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
            ...
            <div style={{ fontSize: '1.4rem', fontWeight: '900', color: T.txtPrimary }}>
              {totalTransactions} <span style={{ fontSize: '0.85rem', color: T.accentGold }}>Struk POS</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <div style={{ border: `1px solid ${T.border}`, borderRadius: '16px', overflow: 'hidden', background: T.cardBg2 }}>
