    ...
    <div style={{ padding: '24px', flex: 1, overflowY: 'auto', background: '#0f172a', color: '#f8fafc' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', background: '#1e293b', padding: '20px 24px', borderRadius: '18px', border: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          {toastSyncSuccess && (
            <div className="animate-fade-in" style={{ background: 'rgba(52, 211, 153, 0.2)', border: '1px solid #34d399', color: '#34d399', padding: '8px 14px', borderRadius: '12px', fontSize: '0.80rem', fontWeight: '800', display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '24px' }}>
        ...
        <div style={{ background: '#1e293b', padding: '18px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.08)' }}>
          <div style={{ fontSize: '0.76rem', color: '#94a3b8', fontWeight: '700' }}>GENERATOR AI INTEGRATED</div>
      ...
      {showAiGeneratorModal && (
        <div style={{
          ...
          <div className="glass-card animate-fade-in" style={{
            width: '100%', maxWidth: '640px', padding: '26px', background: 'linear-gradient(135deg, #1e1b4b 0%, #0f172a 100%)', border: '1px solid #a855f7', borderRadius: '22px', display: 'flex', flexDirection: 'column', gap: '18px', boxShadow: '0 20px 50px rgba(168,85,247,0.3)'
          }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '14px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <h3 style={{ fontSize: '1.2rem', fontWeight: '900', color: '#ffffff', margin: 0, display: 'flex', alignItems: 'center', gap: '6px' }}>
              ...
              <button onClick={() => setShowAiGeneratorModal(false)} style={{ background: 'none', border: 'none', color: '#94a3b8', cursor: 'pointer', fontWeight: '900', fontSize: '1.2rem' }}>✕</button>
            </div>

            {/* PRESET TOPIC CHIPS */}
            <div>
              <label style={{ fontSize: '0.78rem', color: '#cbd5e1', display: 'block', marginBottom: '8px', fontWeight: '700' }}>
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '10px',
                      border: '1px solid',
                      borderColor: aiSelectedPreset === chip.id && !aiCustomTopicPrompt ? '#a855f7' : '#334155',
                      background: aiSelectedPreset === chip.id && !aiCustomTopicPrompt ? 'rgba(168, 85, 247, 0.25)' : '#0f172a',
                      color: aiSelectedPreset === chip.id && !aiCustomTopicPrompt ? '#ffffff' : '#94a3b8',
                      fontSize: '0.78rem',
                      fontWeight: '800',
                      cursor: 'pointer',
                      textAlign: 'left',
            ...
            <div>
              <label style={{ fontSize: '0.78rem', color: '#cbd5e1', display: 'block', marginBottom: '6px', fontWeight: '700' }}>
            ...
            <div style={{ background: 'rgba(168, 85, 247, 0.12)', border: '1px solid rgba(168, 85, 247, 0.3)', padding: '10px 14px', borderRadius: '10px', fontSize: '0.74rem', color: '#a78bfa', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <Zap size={15} />
      ...
      {showModal && (
        <div style={{
          ...
          <div className="glass-card animate-fade-in" style={{
            width: '100%', maxWidth: '750px', maxHeight: '90vh', padding: '26px', background: '#1e293b', border: '1px solid #34d399', borderRadius: '22px', display: 'flex', flexDirection: 'column', gap: '16px'
          }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #334155', paddingBottom: '12px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <button
                  type="button"
                  onClick={() => setShowAiGeneratorModal(true)}
                  style={{ padding: '6px 12px', background: 'rgba(168, 85, 247, 0.2)', border: '1px solid #a855f7', color: '#a78bfa', borderRadius: '8px', fontSize: '0.74rem', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}
                >
                  <Sparkles size={14} />
            ...
            {isAiApplied && (
              <div style={{ background: 'rgba(168, 85, 247, 0.15)', border: '1px solid #a855f7', padding: '10px 14px', borderRadius: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.76rem', color: '#ffffff' }}>
                ...
                <span style={{ fontSize: '0.68rem', background: '#a855f7', color: '#ffffff', padding: '2px 8px', borderRadius: '6px', fontWeight: '900' }}>EDITABLE AI</span>
              </div>
            )}
      ...
      {viewingSop && (
        <div style={{
          ...
          <div className="glass-card animate-fade-in" style={{
            width: '100%', maxWidth: '640px', maxHeight: '85vh', padding: '26px', background: '#1e293b', border: '1px solid #38bdf8', borderRadius: '22px', display: 'flex', flexDirection: 'column', gap: '16px'
          }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #334155', paddingBottom: '12px' }}>
              <div>
                <span style={{ fontSize: '0.72rem', fontWeight: '900', color: '#34d399', background: 'rgba(52, 211, 153, 0.15)', padding: '3px 8px', borderRadius: '6px' }}>
                  {viewingSop.categoryLabel || categoryMap[viewingSop.category]}
                </span>
                <h3 style={{ fontSize: '1.2rem', fontWeight: '900', color: '#ffffff', margin: '6px 0 0 0' }}>
                  {viewingSop.title}
                </h3>
              </div>
            ...
            <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={{ background: '#0f172a', padding: '14px', borderRadius: '12px', border: '1px solid #334155', display: 'flex', justifyContent: 'space-around', fontSize: '0.80rem', color: '#94a3b8' }}>
              ...
              <div>
                <h4 style={{ fontSize: '0.88rem', fontWeight: '900', color: '#38bdf8', marginBottom: '6px' }}>📌 Ringkasan Dokumen:</h4>
